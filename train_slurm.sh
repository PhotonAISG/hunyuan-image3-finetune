...
# Data path
export TRAIN_DATA="./example_data/text/alpaca_train.jsonl"

# Output directory
export OUTPUT_DIR="./logs/hunyuan_multimodal_ft"
...
# Training modes
export TRAIN_TEXT_ONLY=true          # Language modeling on text
export TRAIN_IMAGE_UNDERSTANDING=false  # Vision-language understanding
export TRAIN_IMAGE_GENERATION=false     # Image generation (experimental)
